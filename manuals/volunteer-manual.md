# SyntraAid Volunteer User Manual
...
Submitted attendance entries cannot be edited or deleted. If an error is made, volunteers must submit a new attendance entry and include a note referencing the original entry.
